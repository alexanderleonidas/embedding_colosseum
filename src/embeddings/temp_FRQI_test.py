...
def amplitude_fidelity(pl_state, q_state):     # compares how much the amplitudes of the two embeddings differ
...
for idx in range(NUM_SAMPLES):
    ...
    pixels_q = (pixels * 255).astype(np.float64)    # Qiskit expects non-normalized pixel values 0-255
