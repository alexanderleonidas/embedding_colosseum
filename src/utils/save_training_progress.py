...
class TrainingLogger:
    def __init__(self, run_id, cfg):
        self.run_id = run_id
        self.cfg = cfg
        self.experiment_dir = HydraConfig.get().runtime.output_dir
        os.mkdir(os.path.join(self.experiment_dir, "saved_models"))
        pass
...
if __name__ == "main":
    print(
        "exp_dir: ",
        TrainingLogger(122, 0).save_model_weights_and_bias(
